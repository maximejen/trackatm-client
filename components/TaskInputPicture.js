...
class TaskInputPicture extends React.Component {
  ...
  renderChecked() {
    if (this.state.checked) {
      return <Icon name="check-square" type="feather" />;
    } else {
      return <Icon name="square" type="feather" />;
    }
  }
  ...
  renderImageFlatList() {
    if (this.state.images.length > 0) {
      ...
      return (
        ...
        >
          <Icon name="camera" type="feather" size={70} />
        </TouchableOpacity>
      );
    }
  }
    ...
    return (
      ...
      >
        <ImageView
          ...
          onRequestClose={() => this.setState({ viewer: false })}
        />
        <View
          style={{
            borderStyle: "solid",
